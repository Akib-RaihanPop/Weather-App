const apikey = '59d20c9548202ffd3460d665461f3499';
...
function hourForecast(forecast){
    ...
    document.querySelector('.cast-header').innerText='Future Forecast'
    for (let i = 0; i < 5; i++) {
        ...
        temp.setAttribute('class','nextTemp')
...
function dayForecast(forecast){
    ...
    document.querySelector('.cast-header1').innerText='Next 3 days forecast'
    for (let i = 8; i < forecast.list.length - 8; i+=8) {
